    ...
    if($wsl.State -eq "Enabled") {
	    ...
	    foreach($user in $users){
            ...
            Write-Host "Docker Installed successfully"
     	    New-Item -Path "~/Documents/ionet/" -ItemType Directory
     	    Invoke-WebRequest -Uri https://developer.download.nvidia.com/compute/cuda/12.5.0/network_installers/cuda_12.5.0_windows_network.exe -OutFile "~/Documents/ionet/cuda_12.5.0_windows_network.exe"
	    Invoke-WebRequest -Uri https://github.com/ionet-official/io_launch_binaries/raw/main/io_net_launch_binary_windows.exe -OutFile "~/Documents/ionet/io_net_launch_binary_windows.exe"
